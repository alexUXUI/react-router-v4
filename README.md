...
*Goal:* build an app with **dynamic** routes that are generated by pulling data, which link to other **dynamic** routes which are a result of the data being pulled.
